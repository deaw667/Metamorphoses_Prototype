...
public class CraftingRecipe : Item
{
    ...
    private bool CanCraft()
    {
        ...
        {
            bool containsCurrentIngredient = Inventory.instance.ContainsItemAmount(ingredient.item.name, ingredient.amount);
    ...
    private void RemoveIngredientsFromIventory()
    {
        foreach (Ingredient ingredient in ingredients)
        {
            Inventory.instance.RemoveItemThatAmount(ingredient.item.name, ingredient.amount);
        }
    }
    ...
    public override void Use()
    {
        if (CanCraft())
        {
            ...
            if(!PlayerHealth.instance.PlayedTutorial && result.name == "Rusty Sword")
            {
                TutorialSystem.instance.PlayerCrafted();
            }
        }
        else
        {
